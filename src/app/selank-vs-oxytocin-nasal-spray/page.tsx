...
const TITLE = "Selank vs Oxytocin Nasal Spray | Research Compound Comparison | Titan Peptide Lab";
const DESCRIPTION =
  "Selank vs oxytocin nasal spray: a research-use comparison of two intranasal peptides studied in different literatures — selank in anxiolytic and nootropic research, oxytocin in social-bonding and OXTR-receptor research. What each is, the pathways studied, available formats, and purity documentation. Research use only, not for human use.";

export const metadata: Metadata = {
  title: TITLE,
  description: DESCRIPTION,
  alternates: { canonical: "/selank-vs-oxytocin-nasal-spray/" },
  openGraph: {
    title: TITLE,
    description: DESCRIPTION,
    url: "/selank-vs-oxytocin-nasal-spray/",
    type: "article",
  },
...
const POINTS = [
  {
    ...
    body: "Selank is a synthetic Tuftsin-derived heptapeptide studied in anxiolytic and nootropic research; oxytocin is an endogenous nonapeptide hormone studied at the oxytocin receptor (OXTR) in social-bonding and affiliation research. They get cross-searched because both are intranasal neuropeptides associated with 'calm,' but they sit in separate literatures — which is why Titan stocks each as its own product, not as a substitute for the other.",
    href: "/products/selank-nasal-spray/?ref=selank-vs-oxytocin",
    cta: "View selank spray",
  },
  {
    icon: FlaskConical,
    title: "Oxytocin is the receptor-specific social-behavior compound",
    body: "If your study design is built around social-bonding, affiliation, or OXTR-receptor models, oxytocin — not selank — is the relevant compound, with literature centered on a single well-characterized receptor. Titan supplies oxytocin as a dedicated intranasal research spray with lot documentation referenced to the lot code on the unit.",
    href: "/products/oxytocin-nasal-spray/?ref=selank-vs-oxytocin",
...
const FAQS = [
  {
    q: "What is the difference between selank and oxytocin nasal spray?",
    a: "They are two distinct intranasal research peptides studied in different literatures. Selank is a synthetic Tuftsin-derived heptapeptide examined in anxiolytic and nootropic research, with literature referencing GABA/BDNF and monoamine modulation; oxytocin is an endogenous nonapeptide hormone studied at the oxytocin receptor (OXTR) in social-bonding and affiliation research. Because they engage separate research questions, they are not treated as interchangeable. Both are supplied strictly for in-vitro laboratory research.",
  },
  {
    q: "Are selank and oxytocin used for the same thing in research?",
    a: "No. Although both appear in 'calming' intranasal neuropeptide catalogs, they are studied for different questions — selank in daytime anxiolytic and nootropic contexts, oxytocin in receptor-specific social-bonding and affiliation contexts — so they are not substitutes for one another. Titan provides no protocols, dosing, or human-use guidance; material is research-use only.",
  },
  {
    q: "Which format does Titan offer for selank and oxytocin?",
    a: "Titan supplies each as a dedicated intranasal research spray with lot-matched documentation. See the individual selank nasal spray and oxytocin nasal spray product pages for format details, the lot release sheet, and the testing workflow.",
  },
  {
  ...
  },
  {
    ...
    a: "No. Selank and oxytocin from Titan Peptide Lab are sold strictly for in-vitro laboratory research. They are not for human or animal consumption, diagnostic, therapeutic, or preventative use.",
  },
];

export default function SelankVsOxytocinPage() {
  return (
    <>
      <BreadcrumbJsonLd
        items={[
          { name: "Home", item: "/" },
          { name: "Selank vs Oxytocin Nasal Spray", item: "/selank-vs-oxytocin-nasal-spray/" },
        ]}
      />
      <FAQJsonLd faqs={FAQS} />
      <Nav />
          ...
          <div className="mx-auto max-w-7xl px-5 sm:px-6 lg:px-8">
            <div className="max-w-4xl">
              ...
              <div className="mt-8 flex flex-col gap-3 sm:flex-row">
                ...
                <Link
                  href="/products/oxytocin-nasal-spray/?ref=selank-vs-oxytocin-hero"
                ...
                <tbody>
                  {ROWS.map(([attr, selank, oxytocin]) => (
                    <tr key={attr} className="border-t border-[#eef2f0] align-top">
                      ...
                      <td className="px-5 py-4 leading-7 text-[#5c6762]">{oxytocin}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
        ...
        <section className="py-16 lg:py-24">
          <div className="mx-auto max-w-3xl px-5 sm:px-6">
            ...
            <ul className="mt-7 space-y-3 text-[14px] leading-7 text-[#1e6f58]">
              <li><Link className="hover:underline" href="/where-to-buy-selank-nasal-spray/?ref=selank-vs-oxytocin">Where to buy selank nasal spray →</Link></li>
              <li><Link className="hover:underline" href="/where-to-buy-oxytocin-nasal-spray/?ref=selank-vs-oxytocin">Where to buy oxytocin nasal spray →</Link></li>
              <li><Link className="hover:underline" href="/pt-141-vs-oxytocin-nasal-spray/?ref=selank-vs-oxytocin">PT-141 vs oxytocin nasal spray →</Link></li>
              <li><Link className="hover:underline" href="/dsip-vs-selank-nasal-spray/?ref=selank-vs-oxytocin">DSIP vs selank nasal spray →</Link></li>
              <li><Link className="hover:underline" href="/research/selank-anxiolytic-nootropic/?ref=selank-vs-oxytocin">Selank anxiolytic & nootropic research →</Link></li>
              <li><Link className="hover:underline" href="/research/oxytocin-bonding-social/?ref=selank-vs-oxytocin">Oxytocin bonding & social research →</Link></li>
              <li><Link className="hover:underline" href="/nootropic-nasal-peptides/?ref=selank-vs-oxytocin">Nootropic & nasal peptides →</Link></li>
              <li><Link className="hover:underline" href="/lab-testing/?ref=selank-vs-oxytocin">Lab-testing & COA workflow →</Link></li>
            </ul>
          </div>
        </section>
        ...
        <section className="border-t border-[rgb(15_22_19/6%)] bg-[#fbfcfb] py-16 text-center lg:py-20">
          <div className="mx-auto max-w-3xl px-5 sm:px-6">
            ...
            <p className="mx-auto mt-5 max-w-2xl text-[14px] leading-8 text-[#5c6762]">
              Open the selank or oxytocin nasal spray page for size, lot documentation, and checkout, or browse the full research catalog.
            </p>
            <div className="mt-8 flex flex-col justify-center gap-3 sm:flex-row">
              <Link href="/products/oxytocin-nasal-spray/?ref=selank-vs-oxytocin-bottom" className="inline-flex h-12 items-center justify-center gap-2 rounded-full bg-[#0f1613] px-7 text-[13px] font-semibold text-white transition hover:bg-[#1e6f58]">
                Oxytocin nasal spray
                <ArrowRight className="h-4 w-4" />
              </Link>
              <Link href="/products/?ref=selank-vs-oxytocin-bottom" className="inline-flex h-12 items-center justify-center rounded-full border border-[rgb(15_22_19/12%)] px-7 text-[13px] font-semibold text-[#0f1613] transition hover:border-[#0f1613]">
                Browse catalog
              </Link>
            </div>
          </div>
        </section>
        <CompareMesh current="selank-vs-oxytocin-nasal-spray" />
      </main>
      <Footer />
    </>
  );
