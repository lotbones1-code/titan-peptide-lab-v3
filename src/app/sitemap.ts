...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const pages: MetadataRoute.Sitemap = [
    ...
    { url: `${BASE}/janoshik-coa-verification/`, lastModified: now, changeFrequency: "monthly", priority: 0.88 },
    { url: `${BASE}/current-lot-coa-checklist-research-peptides/`, lastModified: now, changeFrequency: "monthly", priority: 0.88 },
    { url: `${BASE}/what-to-check-before-buying-research-peptides/`, lastModified: now, changeFrequency: "monthly", priority: 0.88 },
    { url: `${BASE}/cloudy-yellow-gelled-peptide-after-reconstitution/`, lastModified: now, changeFrequency: "monthly", priority: 0.86 },
    ...
    { url: `${BASE}/tb-500-for-sale/`, lastModified: now, changeFrequency: "weekly", priority: 0.89 },
    { url: `${BASE}/buy-cjc-1295-ipamorelin-with-crypto/`, lastModified: now, changeFrequency: "weekly", priority: 0.89 },
    ...
    { url: `${BASE}/retatrutide-reconstituted-shelf-life-bac-water/`, lastModified: now, changeFrequency: "monthly", priority: 0.86 },
